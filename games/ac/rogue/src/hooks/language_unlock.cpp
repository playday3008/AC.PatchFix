...
#include "games/ac/rogue/language.hpp"
#include "games/ac/rogue/registry.hpp"

namespace hooks {
    using games::ac::rogue::Language;
    using games::ac::rogue::k_all_menu;
    using games::ac::rogue::k_all_audio;

    namespace {
        using Tag = games::ac::rogue::LanguageUnlockHook;
...
#pragma clang diagnostic pop
    ...
    void HookTraits<games::ac::rogue::LanguageUnlockHook>::on_reload(const Config &cfg) {
    ...
    auto HookTraits<games::ac::rogue::LanguageUnlockHook>::install(const Addrs &addrs) -> bool {
